...
describe('CLIInterface', () => {
  ...
  describe('displayWelcome', () => {
    ...
    it('should display copyright information', () => {
      ...
      expect(allOutput).toContain('2025');
  ...
  describe('getPromptInput', () => {
    ...
    it('should reject on stdin error', async () => {
      ...
      await expect(cliInterface.getPromptInput('Test prompt: ')).rejects.toBe(testError);
    });
  ...
  describe('handleUserChoice', () => {
    ...
    it('should handle ripping service errors', async () => {
      ...
      vi.spyOn(cliInterface.ripService, 'startRipping').mockRejectedValue(ripError);
  ...
  describe('Integration Tests', () => {
    it('should handle complete user interaction flow', async () => {
      ...
      let callCount = 0;
      vi.spyOn(cliInterface, 'handleUserChoice').mockImplementation(async (choice) => {
        callCount++;
        if (choice === '1') {
