...
describe("NativeOpticalDrive", () => {
  ...
  describe("Class structure and platform detection", () => {
    ...
    it("should handle Windows platform detection", () => {
      ...
      // Should not throw platform error on Windows, but may fail for other reasons
      expect(() => {
  ...
  describe("Error handling", () => {
    ...
    it("should handle ejectAllDrives with empty array", async () => {
      await expect(NativeOpticalDrive.ejectAllDrives([])).resolves.toBeUndefined();
    });

    it("should handle loadAllDrives with empty array", async () => {
      await expect(NativeOpticalDrive.loadAllDrives([])).resolves.toBeUndefined();
    });
    ...
    it("should continue processing drives even if some fail", async () => {
      ...
      await expect(NativeOpticalDrive.ejectAllDrives(drives)).resolves.toBeUndefined();
      await expect(NativeOpticalDrive.loadAllDrives(drives)).resolves.toBeUndefined();
    });
  });
  ...
  describe("API consistency", () => {
    it("should have consistent return types", () => {
      ...
      // isNativeAvailable should always return boolean
      const isAvailable = NativeOpticalDrive.isNativeAvailable;
      expect(typeof isAvailable).toBe("boolean");
    });
